...
В этом проекте q агент обучается проходить лабиринт на основе координат где он находится, важно учитывать что нейросети в этом проекте нет, только q агент
